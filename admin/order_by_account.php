                        ...
                        <div class="col-md">
                                ...
                                <tbody id="order_tbody">
                                    <?php
                                        for($i=0;$i<count($results);$i++){
                                            ...
                                            echo "<td><a class='btn btn-sm btn-warning' href='order_acc_details.php?id=".$results[$i]['id']."'>အသေးစိတ်</a></td>";
                                            echo "</tr>";
                                        }
                                    ?>
                                </tbody>
                            ...
                            <form action="order_excel.php" method="post">
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-6">
                                        <button type="submit" class="btn btn-sm btn-success" name="order_acc_excel">Download Excel</button>
                                    </div>
                                    <div class="col-md-3"></div>
                                </div>
                            </form>

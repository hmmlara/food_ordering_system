...
<html lang="en">
    ...
    <nav class="navbar navbar-expand-lg navbar-light mx-sm-auto p-2 fixed-top bg-dark"> 
        <a class="navbar-brand" href="./index.php"><img class="rounded ml-lg-4" src="./img/logo.jpg"></a>
        <button
